        ...
        <div class="scroll-sidebar">
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li> <a href="{{url('/visitor')}}" ><span> <i class="fas fa-cogs"></i> </span><span class="hide-menu">Technologies</span></a></li>
                    ...
                    <li> <a href="{{url('/Photo')}}" ><span><i class="fas fa-sliders-h"></i></span><span class="hide-menu">Setting</span></a></li>
                </ul>
            </nav>
        </div>
    </aside>
