    ...
    <div class="container ">
        <div class="row justify-content-center d-flex mt-5 mb-5">
            ...
            <div class="col-md-10 mt-3 card">
                <div class="row">
                    <div style="height: 450px;font-size: 15px" class="col-md-6 mt-5 p-3">
                        <form  action=" "  class="m-5  loginForm">
                            ...
                            <div class="form-group mt-1">
                                <button name="submit" type="submit" class="btn btn-block btn-primary">Login</button>
                            </div>
                        </form>
                    </div>

                    <div style="height: 100%" class="col-md-6 bg-light">
